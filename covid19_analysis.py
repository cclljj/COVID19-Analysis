...
plot = output_df.plot.scatter(x='T', y='A', xlim=(0.1,200),ylim=(0.0001,10000),logy=True, logx=True, c='DarkBlue')
#plt.show()
fig = plot.get_figure()
fig.savefig(IMG_FOLDER + "/latest_all_A-T.png", bbox_inches='tight')
plt.close(fig)

plot = output_df.plot.scatter(x='T', y='D', xlim=(0.1,200),ylim=(0.0001,1),logy=True, logx=True, c='DarkBlue')
#plt.show()
fig = plot.get_figure()
fig.savefig(IMG_FOLDER + "/latest_all_D-T.png", bbox_inches='tight')
plt.close(fig)

plot = output_df.plot.scatter(x='N', y='A', xlim=(1,10000000),ylim=(0.0001,100000),logy=True, logx=True, c='DarkBlue')
#plt.show()
fig = plot.get_figure()
fig.savefig(IMG_FOLDER + "/latest_all_A-N.png", bbox_inches='tight')
plt.close(fig)

plot = output_df.plot.scatter(x='N', y='D', xlim=(1,10000000),ylim=(0.0001,1),logy=True, logx=True, c='DarkBlue')
#plt.show()
fig = plot.get_figure()
